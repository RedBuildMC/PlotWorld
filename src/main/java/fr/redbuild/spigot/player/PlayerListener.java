...
public class PlayerListener implements Listener {
    ...
    public void onJoin(PlayerJoinEvent event){
        ...
        event.getPlayer().teleport(new Location(Bukkit.getWorld(Main.INSTANCE.getConfig().getString("plotworld.name")), Main.INSTANCE.getConfig().getDouble("plotworld.spawn.x"), Main.INSTANCE.getConfig().getDouble("plotworld.spawn.y"), Main.INSTANCE.getConfig().getDouble("plotworld.spawn.z")));
    }
